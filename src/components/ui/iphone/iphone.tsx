...
/*
  Magic UI iPhone frame (magicui.design/docs/components/iphone), adapted to
  host React screen content for Readen's live mocks.
*/
export const Iphone = ({
  children,
  src,
  ...
  return (
    ...
    >
      ...
      <svg
        ...
        aria-hidden
      >
        <g mask={hasMedia ? `url(#${punchId})` : undefined}>
          <path
        ...
        <path
          ...
          mask={hasMedia ? `url(#${punchId})` : undefined}
        />
